...
import type { Manifest } from '@arbitrage-toolbox/dev-utils';
import { colorLog, ManifestParser } from '@arbitrage-toolbox/dev-utils';
import type { PluginOption } from 'vite';
import { IS_DEV, IS_FIREFOX } from '@arbitrage-toolbox/env';
