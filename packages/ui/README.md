...
{
  "dependencies": {
    "@arbitrage-toolbox/ui": "workspace:*"
  }
}
```
...
```tsx
import '@arbitrage-toolbox/ui/lib/global.css';
```
...
```tsx
import { CustomComponent } from '@arbitrage-toolbox/ui';
...
export function withUI(tailwindConfig: Config): Config {
  return deepmerge(
    ...
    deepmerge(tailwindConfig, {
      content: ['./node_modules/@arbitrage-toolbox/ui/lib/**/*.{tsx,ts,js,jsx}'],
    }),
  );
}
